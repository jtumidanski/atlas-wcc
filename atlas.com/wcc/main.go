...
func main() {
   ...
   go consumers.NewConsumer(l, context.Background(), byte(wid), byte(cid), consumers.MapCharacterHandler{}).Init()
   go consumers.NewConsumer(l, context.Background(), byte(wid), byte(cid), consumers.MapChangedHandler{}).Init()
   go consumers.NewConsumer(l, context.Background(), byte(wid), byte(cid), consumers.MonsterControlHandler{}).Init()
   go consumers.NewConsumer(l, context.Background(), byte(wid), byte(cid), consumers.NewMonsterHandler(byte(wid), byte(cid))).Init()
   go consumers.NewConsumer(l, context.Background(), byte(wid), byte(cid), consumers.EnableActionsHandler{}).Init()
   go consumers.NewConsumer(l, context.Background(), byte(wid), byte(cid), consumers.NewMonsterMovementHandler(byte(wid), byte(cid))).Init()
