...
func readAttackPacket(l logrus.FieldLogger, span opentracing.Span, reader *request.RequestReader, characterId uint32, ranged bool, magic bool) attackPacket {
	reader.ReadByte()
	...
	calculatedMaximumDamage := character.GetCharacterWeaponDamage(l, span)(characterId)
