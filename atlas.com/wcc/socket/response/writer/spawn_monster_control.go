...
func WriteControlMonster(l logrus.FieldLogger) func(m *monster.Model, newSpawn bool, aggro bool) []byte {
	return func(m *monster.Model, newSpawn bool, aggro bool) []byte {
...
func WriteStopControlMonster(l logrus.FieldLogger) func(m *monster.Model) []byte {
	return func(m *monster.Model) []byte {
		w := response.NewWriter(l)
		w.WriteShort(OpCodeSpawnMonsterControl)
		w.WriteByte(0)
		w.WriteInt(m.UniqueId())
