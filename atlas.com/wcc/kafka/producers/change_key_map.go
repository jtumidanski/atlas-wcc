...
func ChangeKeyMap(l logrus.FieldLogger, span opentracing.Span) func(characterId uint32, changes []KeyMapChange) {
	producer := ProduceEvent(l, span, "TOPIC_CHANGE_KEY_MAP")
