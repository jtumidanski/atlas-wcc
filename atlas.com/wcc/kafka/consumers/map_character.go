...
func (h MapCharacterHandler) emptyEventCreator() interface{} {
   return &MapCharacterEvent{}
}

func (h MapCharacterHandler) eventProcessor(l *log.Logger, event interface{}) {
   h.processEvent(l, *event.(*MapCharacterEvent))
}

func (h MapCharacterHandler) processEvent(l *log.Logger, event MapCharacterEvent) {
...
func (h MapCharacterHandler) enter(l *log.Logger, as mapleSession.MapleSession, event MapCharacterEvent) {
...
func (h MapCharacterHandler) exit(_ *log.Logger, as mapleSession.MapleSession, event MapCharacterEvent) {
